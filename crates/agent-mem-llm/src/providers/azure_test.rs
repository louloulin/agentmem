...
#[cfg(test)]
mod tests {
    use super::super::azure::{
        AzureChoice, AzureMessage, AzureProvider, AzureRequest, AzureResponse, AzureUsage,
    };
    ...
    fn test_azure_provider_creation_missing_base_url() {
        ...
        assert!(provider
            .unwrap_err()
            .to_string()
            .contains("endpoint URL is required"));
    }
