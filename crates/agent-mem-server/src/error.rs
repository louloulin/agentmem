...
impl IntoResponse for ServerError {
    fn into_response(self) -> Response {
        let (status, code, message) = match self {
            ServerError::MemoryError(msg) => (StatusCode::INTERNAL_SERVER_ERROR, "MEMORY_ERROR", msg),
            ...
            ServerError::ConfigError(msg) => (StatusCode::INTERNAL_SERVER_ERROR, "CONFIG_ERROR", msg),
            ServerError::TelemetryError(msg) => (StatusCode::INTERNAL_SERVER_ERROR, "TELEMETRY_ERROR", msg),
            ServerError::Internal(msg) => (StatusCode::INTERNAL_SERVER_ERROR, "INTERNAL_ERROR", msg),
        };
